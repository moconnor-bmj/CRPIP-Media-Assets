...
bsn = (function() {
  ...
  var _b = {
    AutoSuggest: function(id, param) {
      ...
      //_b.DOM.addEvent( this.fld, 'keyup', function(event){ return pointer.onKeyPress(event); } );

      this.fld.onkeypress = function(event) {
        return p.onKeyPress(event);
      };
      this.fld.onkeyup = function(event) {
        return p.onKeyUp(event);
      };
  ...
  _b.AutoSuggest.prototype.onKeyPress = function(event) {
  ...
  _b.AutoSuggest.prototype.onKeyUp = function(event) {
    var key = (window.event) ? window.event.keyCode : event.keyCode;
  ...
  _b.AutoSuggest.prototype.getSuggestions = function(val) {
    ...
    if (this.oP.cache && this.nInpC > ol && this.aSug.length > 0) {
      var arr = [];
      ...
      // console.group("Filtered '" + val + "'");
      // console.dir(this.aSug);
      // console.groupEnd();
